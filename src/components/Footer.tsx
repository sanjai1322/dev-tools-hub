    ...
    <footer className="border-t-[6px] border-black bg-[#0080FF] mt-20 shadow-[0_-6px_0px_#000000]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <h3 className="font-black text-2xl text-white mb-6 uppercase tracking-tight">Quick Links</h3>
          ...
          <div>
            <h3 className="font-black text-2xl text-white mb-6 uppercase tracking-tight">Connect</h3>
